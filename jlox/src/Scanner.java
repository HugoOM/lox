...
class Scanner {
	...
	private void scanToken() {
		...
		switch (c) {
			...
			default:
				  // Less tedious than checking for each digit in the root-level switch
				  // if (isDigit(c)) {
				  if (isDigit(c)) {
					  number();
				  } else if (isAlpha(c)) {
	...
	/*
	 * First gives you the character at the current position, 
	 * 	and then moves the pointer forward.
	 */
	private char advance() {
		return source.charAt(current++);
	}

	// Only for single-character lexemes?
